...
public class VistaEstadisticas extends JFrame {
    ...
    private void iniciarComponentes(){
        ...
        lblNombreJugador.setBounds(125,100,250,60);
        ...
        lblTitulo.setBounds(175,50,250,60);
        lblTitulo.setFont(new Font ("Agency FB", Font.BOLD, 30));
        lblTitulo.setHorizontalAlignment(JLabel.LEFT);
        
        lblNombre = new JLabel("NOMBRE : ");
        lblNombre.setBounds(35,100,250,60);
        ...
        lblCantLexema.setBounds(35,140,250,60);
        ...
        lblCantPalabras.setBounds(250,140,250,60);
        ...
        lblFallos.setBounds(35,180,250,60);
        ...
        lblCantFallos.setBounds(150,180,250,60);
        ...
        lblCantAciertos.setBounds(35,220,250,60);
        ...
        lblAciertos.setBounds(150,220,250,60);
        ...
        btnJugar.setBounds(50,400, 150,50);
        btnJugar.setFont(new Font("Agency FB",Font.BOLD,21));

        btnSalir = new JButton("Salir");
        btnSalir.setBounds(225,400, 150,50);
